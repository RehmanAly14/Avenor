...
export default function RegisterPage() {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Start investigating data incidents in minutes."
      footer={
        <>
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4" noValidate>
        ...
        <div>
          ...
          <Input id="name" type="text" required autoComplete="name" placeholder="Jane Doe" icon={<User className="h-4 w-4" />} value={name} onChange={(e) => setName(e.target.value)} />
        </div>
        ...
        <div>
          ...
          <p className="mt-1.5 text-xs text-text-tertiary">At least 8 characters, with an uppercase letter, a lowercase letter, and a number.</p>
        </div>
