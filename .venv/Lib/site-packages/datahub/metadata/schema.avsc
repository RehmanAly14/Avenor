[
    ...
    "fields": [
      {
        "type": "string",
        "name": "alias",
        "doc": "Logical alias used to reference this dataset within its owning semantic model\n(e.g. as `from`/`to` in a `SemanticModelRelationship` join)."
      },
      {
        "Relationship": {
          "entityTypes": [
            ...
            "items": {
              ...
              "fields": [
                ...
                },
                {
                  "type": [
                    "null",
                    "com.linkedin.pegasus2avro.dataset.LineageMatchType"
                  ],
                  "name": "matchType",
                  "default": null,
  ...
  },
  {
    ...
    "Aspect": {
      ...
      "keyForEntity": "mlModelDeployment",
      "entityCategory": "core",
      "entityAspects": [
  ...
  },
  {
    ...
    "Aspect": {
      ...
      "entityDoc": "An AI agent with custom instructions, tools, and scoping. Supports native (DataHub-managed), system (bootstrapped), and external (cataloged) agents."
    },
    "name": "AIAgentKey",
    "namespace": "com.linkedin.pegasus2avro.metadata.key",
    "fields": [
      {
        ...
        "type": "string",
        "name": "id",
        "doc": "Unique identifier for the agent, e.g. \"ask-datahub\" or a generated UUID"
      }
    ],
    "doc": "Key for an AI Agent entity"
  },
  {
    "type": "record",
    "Aspect": {
      "name": "agentSkillKey",
      "keyForEntity": "agentSkill",
      "entityCategory": "core",
      "entityAspects": [
        "agentSkillInfo",
        "dataPlatformInstance",
      ...
      "entityDoc": "A high-level, reusable capability bundle (prompts + tools + domain expertise) that agents adopt. Defined in git and cataloged in DataHub."
    },
    "name": "AgentSkillKey",
    "namespace": "com.linkedin.pegasus2avro.metadata.key",
    "fields": [
      {
        ...
        "type": "string",
        "name": "id",
        "doc": "Unique identifier for the skill, e.g. \"customer-service-skill\" or a\ngenerated UUID."
      }
    ],
    "doc": "Key for an AgentSkill entity \u2014 a high-level, reusable capability bundle\n(prompts + tools + domain expertise) that agents can adopt."
  },
  {
    "type": "record",
    "Aspect": {
      "name": "semanticModelKey",
      "keyForEntity": "semanticModel",
      "entityCategory": "core",
      "entityAspects": [
        "semanticModelInfo",
        "upstreamLineage",
  ...
  },
  {
    ...
    "fields": [
      ...
      },
      {
        ...
        "type": "string",
        "name": "path",
        "doc": "Namespace path that scopes this metric within its platform. Ingestors must set this to\nthe canonical container path for the metric so that two teams can define metrics with the\nsame `id` on the same platform without colliding."
      },
      {
        "type": "string",
        "name": "id",
        "doc": "Unique identifier for the metric within its platform and path."
      }
    ],
    "doc": "Key for a Metric"
  },
  {
    "type": "record",
    "Aspect": {
      "name": "dataHubConnectionKey",
      "keyForEntity": "dataHubConnection",
      "entityCategory": "internal",
      "entityAspects": [
  ...
  },
  {
    ...
    "Aspect": {
      ...
      "keyForEntity": "lifecycleStageType",
      "entityCategory": "core",
      "entityAspects": [
        "lifecycleStageTypeInfo",
        "status"
      ],
      "entityDoc": "Defines a lifecycle stage that entities can be placed in (e.g., Proposed, Certified, Archived). Controls search visibility and transition policies."
    },
    "name": "LifecycleStageTypeKey",
    "namespace": "com.linkedin.pegasus2avro.metadata.key",
    "fields": [
      {
        "type": "string",
        "name": "id",
        "doc": "Unique identifier for the lifecycle stage type, e.g. \"PROPOSED\", \"CERTIFIED\", \"ARCHIVED\"."
      }
    ],
    "doc": "Key for a Lifecycle Stage Type"
  },
  {
    "type": "record",
    "Aspect": {
      ...
      "entityDoc": "A named callable with a typed input and output schema (an MCP tool, REST endpoint, gRPC method, GraphQL operation, function, etc.). Cataloged as a first-class entity for discovery and caller-to-API dependency tracking (services that compose APIs, agents that invoke them)."
    },
    "name": "ApiKey",
    "namespace": "com.linkedin.pegasus2avro.metadata.key",
    "fields": [
      {
        ...
        "type": "string",
        "name": "id",
        "doc": "Unique identifier for the API, e.g. \"order-lookup-mcp\" or a generated UUID."
      }
    ],
    "doc": "Key for an API entity \u2014 a named callable with a typed input and output\nschema (an MCP tool, REST endpoint, gRPC method, GraphQL operation, function,\netc.) that can be invoked by humans, services, or AI agents."
  },
  {
    "type": "record",
    "Aspect": {
    ...
    "fields": [
      {
        "type": "string",
        "name": "id",
        "doc": "A unique id for the Action, either generated or provided"
      }
    ],
    ...
    "fields": [
      {
        "type": "string",
        "name": "id",
        "doc": "A unique id for the persona type"
      }
    ],
    "doc": "Key for a persona type"
  },
  {
    "type": "record",
    "Aspect": {
  ...
  "com.linkedin.pegasus2avro.metadata.query.filter.Filter",
  {
    ...
    "name": "DataHubPersonaInfo",
    "namespace": "com.linkedin.pegasus2avro.persona",
    "fields": [],
  ...
  },
  {
    ...
    "fields": [
      ...
      },
      {
        ...
        "name": "uniqueUserCount",
        "default": null,
        "doc": "Number of distinct human users that read this document in this bucket"
      },
      {
        "TimeseriesField": {},
        "type": [
        ...
        "name": "lastViewedAt",
        "default": null,
        "doc": "Timestamp (epoch millis) the document was last read, by either a human or an agent"
      },
      {
        "TimeseriesFieldCollection": {
          "key": "user"
        ...
        "type": [
          ...
          {
            "type": "array",
            "items": "com.linkedin.pegasus2avro.dataset.DatasetUserUsageCounts"
          }
        ],
        "name": "userCounts",
        "default": null,
        "doc": "Human users within this bucket, with frequency counts. Agent reads are excluded."
      }
    ],
    "doc": "Experimental (Subject to breaking change) -- Stats corresponding to a document's usage.\n\nIf this aspect represents the latest snapshot of the statistics about a Document, the eventGranularity field should be null.\nIf this aspect represents a bucketed window of usage statistics (e.g. over a day), then the eventGranularity field should be set accordingly."
  },
  {
    "type": "record",
    "Aspect": {
  ...
  },
  {
    ...
    "fields": [
      ...
      },
      {
        ...
        "type": [
          "null",
          "com.linkedin.pegasus2avro.common.FabricType"
        ],
        "name": "env",
        "default": null,
  ...
  },
  {
    ...
    "fields": [
      ...
      },
      {
        "type": [
          "null",
          "com.linkedin.pegasus2avro.schema.SchemaFieldDataType"
        ],
        "name": "type",
        "default": null
      }
                  ...
                  "null",
                  {
                    ...
                    "fields": [
                      ...
                      },
                      {
                        ...
                        "name": "requiredGroups",
                        "default": null,
                        "doc": "ADVANCED. Restrict login to users who belong to at least one of these groups (matched against the groups claim). Empty or unset disables group-based access enforcement."
                      },
                      {
                        "type": [
                          "null",
                        ...
                        "default": null,
                        "doc": "ADVANCED. Message shown to users who are denied login because they are not a member of any required group."
                      },
                      {
                        "type": [
                          "null",
                        ...
                        "name": "accessDeniedRedirectUrl",
                        "default": null,
                        "doc": "ADVANCED. URL to redirect denied users to (e.g. an internal access-request page). When set, takes precedence over the access denied message."
                      }
                    ],
  ...
  },
  {
    ...
    "name": "SemanticModelInfo",
    "namespace": "com.linkedin.pegasus2avro.semanticmodel",
    "fields": [
      {
        "Searchable": {
          "fieldType": "KEYWORD"
            ...
            "items": {
              ...
              "fields": [
                ...
                },
                {
                  "type": [
                    "null",
                    "com.linkedin.pegasus2avro.common.AiContext"
                  ],
                  "name": "aiContext",
                  "default": null,
                ...
                },
                {
                  "type": [
                    "null",
                    "com.linkedin.pegasus2avro.ermodelrelation.ERModelRelationshipCardinality"
                  ],
                  "name": "cardinality",
                  "default": null,
    ...
    "fields": [
      {
        "type": {
          ...
          "doc": "Discriminator enum that identifies the kind of a SchemaField's SemanticFieldAnnotation\ninside a SemanticModel dataset."
        },
        "name": "type",
        "doc": "The kind of this field. Must be set for every annotated field; determines how downstream\ntools interpret the field and whether kind-specific sub-records (e.g. `dimension`) are\nrelevant."
      },
      {
        "type": "com.linkedin.pegasus2avro.metric.MetricExpression",
        "name": "expression",
      ...
      },
      {
        ...
        "default": null,
        "doc": "The aggregation function applied to this field when used as a measure\n(e.g. \"SUM\", \"COUNT_DISTINCT\", \"AVG\"). Populated when `type == MEASURE`; ignored otherwise."
      },
      {
        "type": [
          "null",
  ...
  },
  {
    ...
    "name": "DataHubConnectionDetails",
    "namespace": "com.linkedin.pegasus2avro.connection",
    "fields": [
      {
        "Searchable": {},
        "type": {
              ...
              },
              {
                "type": [
                  "null",
                  {
                    ...
                    "fields": [
                      {
                        "type": "com.linkedin.pegasus2avro.assertion.AssertionResultSeverity",
                  ...
                  "null",
                  {
                    ...
                    "fields": [
                      ...
                      },
                      {
                        "type": [
                          "null",
                          "com.linkedin.pegasus2avro.assertion.AssertionFailureSeverityConfig"
                        ],
                        "name": "failureSeverityConfig",
                        "default": null,
                  ...
                  "null",
                  {
                    ...
                    "fields": [
                      ...
                      },
                      {
                        "type": [
                          "null",
                          "com.linkedin.pegasus2avro.assertion.AssertionStdParameters"
                        ],
                        "name": "parameters",
                        "default": null,
                        "doc": "Standard parameters required for the assertion. e.g. min_value, max_value, value, columns"
          ...
          "null",
          {
            ...
            "fields": [
              ...
              },
              {
                "type": [
                  "null",
                  "com.linkedin.pegasus2avro.assertion.DatasetAssertionScope"
                ],
                "name": "scope",
                "default": null,
              ...
              },
              {
                "type": [
                  "null",
                  "com.linkedin.pegasus2avro.assertion.AssertionStdAggregation"
                ],
                "name": "aggregation",
                "default": null,
              ...
              },
              {
                "type": [
                  "null",
                  "com.linkedin.pegasus2avro.assertion.AssertionStdOperator"
                ],
                "name": "operator",
                "default": null,
                "doc": "Standardized assertion operator."
  ...
  },
  {
    ...
    "name": "ServiceProperties",
    "namespace": "com.linkedin.pegasus2avro.service",
    "fields": [
      {
        "Searchable": {
          "boostScore": 10.0,
  ...
  },
  {
    ...
    "Aspect": {
      ...
      "entityDoc": "A Service represents an external service that can be integrated with DataHub, such as an MCP server."
    },
    "name": "ServiceKey",
    "namespace": "com.linkedin.pegasus2avro.service",
    "fields": [
  ...
  },
  {
    ...
    "name": "RepositorySource",
    "namespace": "com.linkedin.pegasus2avro.repository",
    "fields": [
      {
        "type": [
          "null",
        ...
        "name": "externalUrl",
        "default": null,
        "doc": "The web or clone URL of the repository in its source system."
      },
      {
        "type": [
          "null",
        ...
        "name": "externalId",
        "default": null,
        "doc": "The identifier of the repository in its source system (e.g. a GitHub\nnumeric repo id or an org/name slug)."
      }
    ],
    "doc": "The source binding for a Repository \u2014 where the repository lives and how it is\nidentified in its source system. Reusable across any synced or native repo."
  },
  {
    "type": "record",
    "Aspect": {
    ...
    "fields": [
      {
        ...
        "type": "string",
        "name": "name",
        "doc": "Display name of the repository, shown in UI and search results."
      },
      {
        "Searchable": {
          "fieldType": "TEXT",
        ...
        "name": "description",
        "default": null,
        "doc": "Description of what this repository contains."
      },
      {
        "type": [
          "null",
        ...
        "name": "defaultBranch",
        "default": null,
        "doc": "The default branch of the repository (e.g. \"main\", \"master\")."
      },
      {
        "type": [
          "null",
      ...
      },
      {
        ...
        "name": "license",
        "default": null,
        "doc": "The license of the repository (e.g. \"Apache-2.0\", \"MIT\")."
      },
      {
        "type": [
          "null",
        ...
        "name": "homepageUrl",
        "default": null,
        "doc": "A link to the repository's homepage or documentation."
      },
      {
        "type": [
          "null",
        ...
        "name": "archived",
        "default": null,
        "doc": "Whether the repository is archived (read-only / no longer maintained)."
      },
      {
        "Searchable": {
          "/time": {
        ...
        "name": "created",
        "default": null,
        "doc": "When this repository was created."
      },
      {
        "Searchable": {
          "/time": {
  ...
  },
  {
    ...
    "Aspect": {
      ...
      "entityDoc": "A source-code repository (GitHub, GitLab, internal SCM, etc.). The genesis node of the software-to-data lifecycle (repo -> service -> api -> app -> dataset); produces the services, APIs, and apps cataloged elsewhere. Not tabular (no columns/queries/stats)."
    },
    "name": "RepositoryKey",
    "namespace": "com.linkedin.pegasus2avro.repository",
    "fields": [
    ...
    "fields": [
      {
        ...
        "name": "forkOf",
        "default": null,
        "doc": "The repository this one is a git fork of. A plain provenance edge."
      }
    ],
    "doc": "Provenance edges between Repository entities."
  },
  {
    "type": "record",
    "Aspect": {
            ...
            "fields": [
              {
                "Searchable": {
                  "addHasValuesToFilters": true,
                  "fieldType": "KEYWORD",
                  "hasValuesFieldName": "hasScheduleInterval",
                  "queryByDefault": false
                },
                "type": "string",
                "name": "interval",
  ...
  },
  {
    ...
    "name": "AIAgentDependencies",
    "namespace": "com.linkedin.pegasus2avro.agent",
    "fields": [
      {
        "Relationship": {
          "/*": {
  ...
  },
  {
    ...
    "name": "ApiProperties",
    "namespace": "com.linkedin.pegasus2avro.api",
    "fields": [
      {
        "Searchable": {
          "boostScore": 10.0,
  ...
  },
  {
    ...
    "name": "AgentSkillInfo",
    "namespace": "com.linkedin.pegasus2avro.agentskill",
    "fields": [
      {
        "Searchable": {
          "boostScore": 10.0,
                    ...
                    "com.linkedin.pegasus2avro.metadata.key.DataPlatformKey",
                    {
                      ...
                      "fields": [
                        ...
                        },
                        {
                          ...
                          "name": "logical",
                          "default": null,
                          "doc": "Whether datasets on this platform are logical models (hand-authored, no ingestion source)."
                        },
                        {
                          "java": {
                            "class": "com.linkedin.pegasus2avro.common.url.Url",
  ...
  },
  {
    ...
    "name": "LifecycleStageTypeInfo",
    "namespace": "com.linkedin.pegasus2avro.lifecycle",
    "fields": [
      {
        "Searchable": {
          "boostScore": 10.0,
